...
function getOffsetRect(e) {
    var t = e.getBoundingClientRect(), i = document.body, a = document.documentElement,
        r = window.pageYOffset || a.scrollTop || i.scrollTop, s = window.pageXOffset || a.scrollLeft || i.scrollLeft,
...
-1 == navigator.appVersion.indexOf("MSIE 8.0") && -1 == navigator.appVersion.indexOf("MSIE 9.0") && -1 == navigator.appVersion.indexOf("MSIE 10.0") || "BackCompat" == document.compatMode || (_isIE = 8)) : "Netscape" == navigator.appName && -1 != navigator.userAgent.indexOf("Trident") ? _isIE = 8 : (_isFF = !0, _FFrv = parseFloat(navigator.userAgent.split("rv:")[1])), dtmlXMLLoaderObject.prototype.doXPath = function (e, t, i, a) {
    ...
    function a(e, t, i) {
        var a = scheduler._waiAria.messageButtonAttrString(e), r = i ? i : e || "",
    ...
    setTransactionMode: function (e, t) {
        ...
        if (window.JSON) try {
            var a = JSON.parse(t.xmlDoc.responseText), r = a.action || this.getState(i) || "updated", s = a.sid || i[0],
                n = a.tid || i[0];
    ...
    scheduler._waiAria = {
        getAttributeString: function (i) {
            ...
            var i = e.querySelector(".dhx_wa_scale_bar"), a = e.querySelector(".dhx_wa_day_data"),
                r = scheduler.uid() + "";
    ...
    if (!e || 2 != e.button || !scheduler.config.touch) {
        if (this._drag_mode && this._drag_id) {
            ...
            var t = this._drag_id, i = this._drag_mode, a = !this._drag_pos || this._drag_pos.has_moved,
    ...
    var i = new Date(scheduler._min_date), a = new Date(scheduler._max_date),
        r = this.date.date_part(scheduler._currentDate()), s = parseInt(e.style.width, 10),
        n = new Date(this._min_date), d = this._get_columns_num(i, a);
    ...
    init: function () {
        ...
        var a = i.getFullYear(), r = Math.round((i.getTime() - new Date(a, 0, 1).getTime()) / 864e5),
            s = 1 + Math.floor(r / 7);
        return s
    ...
    if (t) {
        var i = e.start_date.getHours(), a = e.end_date.getHours() + e.end_date.getMinutes() / 60,
            r = this.config.last_hour, s = this.config.first_hour,
    ...
    for (var t = this._rendered_location, i = this._lame_clone(e), a = e._sday; a < e._eday; a++) {
        ...
        var n = scheduler.getEvents(s, r.add(s, 1, "day")).length, d = this._get_event_bar_pos(i), l = d.x2 - d.x,
...
scheduler.render_data = function (e, t) {
    ...
    var i = this.xy.bar_height, a = this._colsS.heights, r = this._colsS.heights = [0, 0, 0, 0, 0, 0, 0],
    ...
    var i = 60 * e.start_date.getHours() + e.start_date.getMinutes(),
        ...
        r = this._y_from_date(e.start_date), s = Math.max(t, (a - i) * this.config.hour_size_px / 60);
    ...
    if (!(e._sday < 0)) {
        ...
        if (a) {
            var r = this._calc_event_y(e, scheduler.xy.min_event_height), s = r.top, n = r.height, d = e._count || 1,
                l = e._sorder || 0, o = Math.floor((a.clientWidth - i) / d), h = l * o + 1;
    ...
    if (s) {
        var d = scheduler.config.resize_month_events && "month" == this._mode && (!e._timed || scheduler.config.resize_month_timed),
            l = document.createElement("DIV"), o = e.hasOwnProperty("_first_chunk") && e._first_chunk,
            h = e.hasOwnProperty("_last_chunk") && e._last_chunk, _ = d && (e._timed || o), c = d && (e._timed || h),
        ...
        g && (u += " " + g);
        var v = e.color ? "background:" + e.color + ";" : "", f = e.textColor ? "color:" + e.textColor + ";" : "",
...
scheduler.formSection = function (e) {
    ...
    template: {
        ...
        render: function (e) {
            ...
            var t = e.time_format, i = scheduler.config, a = this.date.date_part(scheduler._currentDate()), r = 1440,
                s = 0;
    ...
    for (var l = this.config.lightbox.sections, o = 0; o < l.length; o++) {
        var h = l[o], _ = document.getElementById(h.id).nextSibling, c = this.form_blocks[h.type],
    ...
    a(document.body, e[0], function (e) {
        ...
        if (!i(e)) {
            ...
            if (u = r, !_ && !h && scheduler.config.touch_drag) {
                var s = scheduler._locate_event(document.activeElement), n = scheduler._locate_event(a.target),
